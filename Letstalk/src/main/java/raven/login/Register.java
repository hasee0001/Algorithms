    ...
    private void init() throws SQLException {
        ...
        cmdRegister.addActionListener(e -> {
            if (isMatchPassword()) {
                ...
                DatabaseConnector.insertUser(username, password, email, firstName + " " + lastName, gender);
                // Optionally, you can show a success message or navigate to another screen
                Notifications.getInstance().show(Notifications.Type.SUCCESS, "Registration successful!");
                // Navigate to another form or perform any other actions after successful registration
            } else {
                // Show error message...
